...
export const Route = createFileRoute("/_authenticated/feedback")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review past training sessions, record workout feedback, and share effort notes with your coach." },
      { property: "og:title", content: "CoachDesk Feedback — Log training sessions" },
      { property: "og:description", content: "Review past training sessions, record workout feedback, and share effort notes with your coach." },
      ...
      <div className="h-[calc(100vh-3.5rem)] overflow-auto">
        <div className="mx-auto max-w-[1000px] p-6">
          <Tabs defaultValue="mine">
            ...
            <TabsContent value="mine"><MyFeedback /></TabsContent>
            <TabsContent value="clients"><CoachFeedback embedded /></TabsContent>
          </Tabs>
        </div>
      </div>
    );
