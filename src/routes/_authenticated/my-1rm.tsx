      ...
      <div className="flex h-[calc(100vh-3.5rem)] items-center justify-center px-4">
        <Card className="max-w-md p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Your coach needs to add you as a client before you can track 1RMs.
          </p>
        </Card>
      </div>
    );
    ...
    <div className="h-[calc(100vh-3.5rem)] overflow-auto">
      <div className="mx-auto max-w-2xl space-y-4 p-6">
        ...
        <p className="text-sm text-muted-foreground">
          Track your one-rep max per strength exercise. Used for % 1RM
          prescriptions in your plan.
        </p>
            ...
            <div className="col-span-12 sm:col-span-6 space-y-1">
              ...
              <Select value={pickerExId} onValueChange={setPickerExId}>
                <SelectTrigger className="h-9">
                  <SelectValue placeholder="Select gym exercise…" />
                </SelectTrigger>
                <SelectContent>
                  {exercises.map((e) => (
        ...
        <div className="space-y-2">
          ...
          {tracked.length === 0 && (
            <p className="rounded border border-dashed p-6 text-center text-sm text-muted-foreground">
              No 1RM values recorded yet. Add one above to enable % 1RM
              prescriptions.
            </p>
          )}
            ...
            return (
              <div key={ex!.id} className="rounded border bg-card">
                <div className="flex items-center gap-2 p-3">
                  ...
                  >
                    <History className="mr-1 h-3.5 w-3.5" /> {entries.length}{" "}
